...
FINE_CLASS_VOCAB: list[dict[str, Any]] = [
    ...
    {"id": 8, "name_zh": "果壳箱", "name_en": "trash bin", "aliases": ["果壳箱", "垃圾桶", "bin", "trash can", "litter bin"]},
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Task3 batch scene classification with GLM-V."
    )
    parser.add_argument("--data-root", required=True, help="benchmark data root")
    parser.add_argument("--model-path", default=DEFAULT_MODEL_PATH, help="GLM model path")
    ...
    for scene_dir in scene_dirs:
        ...
        for idx, image_path in enumerate(images, start=1):
            ...
            try:
                ...
                raw_response, answer_text = run_glm_classification(
                    model=model,
                    processor=processor,
                ...
                classes = parse_classification_response(answer_text)
